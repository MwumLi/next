...
function (_Animator) {
  ...
  (0, _createClass2.default)(Animation, [{
    ...
    value: function finish() {
      ...
      (0, _animation_frame.cancelAnimationFrame)(this.requestId);
    ...
    value: function play() {
      ...
      this.ready.then(function () {
        ...
        that.requestId = (0, _animation_frame.requestAnimationFrame)(function update() {
          ...
          if (playState === 'running') {
            that.requestId = (0, _animation_frame.requestAnimationFrame)(update);
        ...
        return new Promise(function (resolve) {
          function update() {
            ...
            if (playState === 'finished' || playState === 'idle') {
              (0, _animation_frame.cancelAnimationFrame)(that.requestId);
              resolve();
            } else {
              (0, _animation_frame.requestAnimationFrame)(update);
            }
          }
