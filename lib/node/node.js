  ...
  (0, _createClass2.default)(Node, [{
    ...
    value: function dispatchEvent(event) {
      ...
      for (var i = elements.length - 1; i >= 0; i--) {
        ...
        var listeners = element[_captureEventListeners][type];
      ...
      if (!event.cancelBubble) {
        for (var _i = 0; _i < elements.length; _i++) {
          ...
          var _listeners = _element[_eventListeners][type];
    ...
    key: "setResolution",
    value: function setResolution(_ref3) {
    ...
    value: function transition(sec) {
      ...
      return _ref6 = {}, (0, _defineProperty2.default)(_ref6, _animation, null), (0, _defineProperty2.default)(_ref6, "cancel", function cancel() {
      ...
      }), (0, _defineProperty2.default)(_ref6, "end", function end() {
        var animation = this[_animation];

        if (animation && (animation.playState === 'running' || animation.playState === 'pending')) {
          animation.finish();
        }
      }), (0, _defineProperty2.default)(_ref6, "reverse", function reverse() {
        var animation = this[_animation];
      ...
      }), (0, _defineProperty2.default)(_ref6, "attr", function attr(prop, val) {
        this.end();
        ...
        Object.entries(prop).forEach(function (_ref4) {
