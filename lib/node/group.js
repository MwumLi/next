...
function (_Block) {
  ...
  (0, _createClass2.default)(Group, [{
    ...
    value: function setResolution(_ref) {
      ...
      if ((0, _get2.default)((0, _getPrototypeOf2.default)(Group.prototype), "setResolution", this).call(this, {
        width: width,
        height: height
      })) {
        this.children.forEach(function (child) {
    ...
    value: function replaceChild(el, ref) {
      el.remove();
      var refIdx = this.children.indexOf(ref);
    ...
    value: function insertBefore(el, ref) {
      ...
      for (var i = refIdx; i < this.children.length; i++) {
        var order = this.children[i].zOrder;
    ...
    key: "draw",
    value: function draw() {
      var meshes = (0, _toConsumableArray2.default)((0, _get2.default)((0, _getPrototypeOf2.default)(Group.prototype), "draw", this).call(this));
      this.orderedChildren.forEach(function (child) {
        var res = child.draw();
        if (res) meshes.push.apply(meshes, (0, _toConsumableArray2.default)(res));
      });
      return meshes;
    }
  }, {
    ...
    get: function get() {
      if (!this[_ordered]) {
        this[_ordered] = (0, _toConsumableArray2.default)(this.children);
