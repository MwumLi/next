...
function (_Block) {
  ...
  (0, _createClass2.default)(Label, [{
    ...
    value: function updateText() {
      ...
      if (!this[_textImageTask]) {
        this[_textImageTask] = new Promise(function (resolve) {
          (0, _animation_frame.requestAnimationFrame)(function () {
    ...
    /* override */
    value: function draw() {
      var meshes = (0, _get4.default)((0, _getPrototypeOf2.default)(Label.prototype), "draw", this).call(this);
      ...
      if (meshes && meshes.length) {
        ...
        if (textImage) {
          ...
          if (!texture || this[_textureContext] && this[_textureContext] !== this.renderer || texture.image !== textImage) {
            texture = (0, _texture_loader.createTexture)(textImage, this.renderer);
            this[_updateTextureRect] = true;
          } else {
