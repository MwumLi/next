...
function (_Node) {
  ...
  (0, _createClass2.default)(Block, [{
    ...
    value: function setResolution(_ref) {
      ...
      if ((0, _get2.default)((0, _getPrototypeOf2.default)(Block.prototype), "setResolution", this).call(this, {
        width: width,
        height: height
      })) {
    ...
    value: function draw() {
      ...
      if (borderBoxMesh) (0, _render_event.default)(this, borderBoxMesh);else if (clientBoxMesh) (0, _render_event.default)(this, clientBoxMesh);
      return ret;
    }
  }, {
    key: "contentSize",
